...
bot = telebot.TeleBot('7236145909:AAESxbwn7GdveA2A1IsWtW8BbC8jVvCbRSs')
...
Buy From :- @MrRanDom8
Official Channel :- https://t.me/@MrRanDom
'''
...
def welcome_start(message):
    ...
    response = f'''Welcome to premium DDOS of MR RANDOM.
BUY :- @MrRanDom8'''
    bot.reply_to(message, response)
...
3. MAKE SURE YOU JOINED https://t.me/@MrRanDom8 OTHERWISE NOT WORK
